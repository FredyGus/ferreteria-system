...
public class ClientesController {
    ...
    @FXML private TableColumn<Cliente,String> colId,colNombre,colNit,colTelefono,colEmail;
    ...
    @FXML private void guardar(){
        try{
            ...
            c.setNombre(txtNombre.getText()); c.setNit(txtNit.getText());
            c.setTelefono(txtTelefono.getText()); c.setEmail(txtEmail.getText());
    ...
    @FXML private void eliminar(){
        if (seleccionado==null){ warn("Selecciona un cliente"); return; }
        try{
    ...
    private void alert(Alert.AlertType t, String h, String m){ var a=new Alert(t); a.setHeaderText(h); a.setContentText(m); a.setTitle("Clientes"); a.showAndWait(); }
}
