-- =========================================================
-- PROYECTO: Ferretería - Modelo de datos (F1)
-- Crea schema, tablas, FKs, índices y datos semilla.
-- Compatible MySQL 8/9 (InnoDB, utf8mb4)
-- =========================================================

-- 0) Opcional: crea el SCHEMA si no existe
CREATE DATABASE IF NOT EXISTS ferreteria
  CHARACTER SET utf8mb4
  COLLATE utf8mb4_0900_ai_ci;
USE ferreteria;

-- Por seguridad en desarrollo
...
-- =========================================================
-- 2) MOVIMIENTOS DE INVENTARIO / VENTAS
-- =========================================================
...
-- (Para reportes) ventas por día con total
...
-- =========================================================
-- 4) DATOS SEMILLA (solo ejemplo para comenzar)
-- =========================================================
...
-- Productos (stock 0 inicial, se incrementará con ingresos)
